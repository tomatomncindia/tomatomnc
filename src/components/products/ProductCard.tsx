...
export function ProductCard({ product }: { product: Product }) {
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-line bg-white transition-[transform,box-shadow,border-color] duration-300 [transition-timing-function:var(--ease-out-quint)] hover:-translate-y-1.5 hover:shadow-[var(--shadow-card-hover)] hover:border-line-strong"
    >
      ...
      <div className="p-5 md:p-6">
        ...
        <p className="mt-5 inline-flex items-center gap-1.5 text-[13px] font-medium text-forest">
          View product
