...
export function StatStrip({
  ...
  return (
    ...
    >
      {stats.map((s) => (
        <div key={s.label} className="px-4 py-6 md:px-8 md:py-7 first:pl-0 last:pr-0">
          <dt
            className={cn(
          ...
          <dd className="mt-2 font-display text-3xl md:text-5xl font-medium tracking-tight">
