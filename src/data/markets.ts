...
export const REGIONS: Region[] = [
  ...
  },
  {
    name: "East Asia",
    countries: 4,
    description: "Established partners across Japan, China, Taiwan, and the Korean domestic market.",
  },
  {
    name: "Southeast Asia",
    countries: 6,
    description: "Active distribution in Vietnam, Thailand, Malaysia, Indonesia, the Philippines, and Singapore.",
  },
  {
